...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xe6, 0x02, 0x0a, 0x06,
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x42, 0x0a, 0x04, 0x68, 0x74, 0x74, 0x70, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75,
	...
	0x48, 0x54, 0x54, 0x50, 0x52, 0x04, 0x68, 0x74, 0x74, 0x70, 0x12, 0x42, 0x0a, 0x04, 0x67, 0x72,
	0x70, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x61,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x69,
	...
	0x65, 0x6f, 0x75, 0x74, 0x22, 0x9f, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x4c, 0x0a,
	0x08, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x30, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x73, 0x65,
	...
	0x65, 0x52, 0x08, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x43, 0x0a, 0x05, 0x72,
	0x65, 0x64, 0x69, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x61, 0x70, 0x70,
	...
	0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x61, 0x64, 0x64, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x75, 0x74, 0x68, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x61, 0x75, 0x74, 0x68, 0x12, 0x3c, 0x0a, 0x0c, 0x72, 0x65, 0x61, 0x64,
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x77, 0x65, 0x62, 0x6c, 0x66, 0x65, 0x2f, 0x66, 0x6c, 0x79, 0x66,
	0x69, 0x72, 0x65, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2f,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server)(nil),              // 1: app.account.service.internal.conf.Server
	(*Data)(nil),                // 2: app.account.service.internal.conf.Data
	(*Server_HTTP)(nil),         // 3: app.account.service.internal.conf.Server.HTTP
	(*Server_GRPC)(nil),         // 4: app.account.service.internal.conf.Server.GRPC
	(*Data_Database)(nil),       // 5: app.account.service.internal.conf.Data.Database
	(*Data_Redis)(nil),          // 6: app.account.service.internal.conf.Data.Redis
	(*durationpb.Duration)(nil), // 7: google.protobuf.Duration
}
var file_internal_conf_conf_proto_depIdxs = []int32{
	1,  // 0: app.account.service.internal.conf.Bootstrap.server:type_name -> app.account.service.internal.conf.Server
	2,  // 1: app.account.service.internal.conf.Bootstrap.data:type_name -> app.account.service.internal.conf.Data
	3,  // 2: app.account.service.internal.conf.Server.http:type_name -> app.account.service.internal.conf.Server.HTTP
	4,  // 3: app.account.service.internal.conf.Server.grpc:type_name -> app.account.service.internal.conf.Server.GRPC
	5,  // 4: app.account.service.internal.conf.Data.database:type_name -> app.account.service.internal.conf.Data.Database
	6,  // 5: app.account.service.internal.conf.Data.redis:type_name -> app.account.service.internal.conf.Data.Redis
	7,  // 6: app.account.service.internal.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	7,  // 7: app.account.service.internal.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	7,  // 8: app.account.service.internal.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	7,  // 9: app.account.service.internal.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
